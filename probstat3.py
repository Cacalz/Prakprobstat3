...
n_trials_Calista = 10  # Jumlah percobaan
probabilities_Calista = [0.2, 0.3, 0.5]  # Probabilitas untuk masing-masing kategori

# Buat objek distribusi Multinomial
multinom_dist_Calista = multinomial(n_trials_Calista, probabilities_Calista)

# Generate sampel dari distribusi Multinomial
sample_Calista = multinom_dist_Calista.rvs()
print("Sampel hasil percobaan:")
print(sample_Calista)

# Hitung probabilitas massa dari sampel yang dihasilkan
pmf_sample_Calista = multinom_dist_Calista.pmf(sample_Calista)
print("\nProbabilitas massa dari sampel yang dihasilkan:", pmf_sample_Calista)
